# Start "dyalog/jsonserver" docker image to server "involute" web service
# See invoke.ps1 for an example call to the running service
# 
$vol = "C:\Devt\deliverapl\WebService:/code" # Mapp application code to /code in container
...
docker run -v $vol -e $ride -p "4502:4502" -p "8080:8080" dyalog/jsonserver